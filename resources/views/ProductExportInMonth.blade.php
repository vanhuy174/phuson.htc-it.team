...
<table class="table">
    <tr>
        ...
        <th style="border: 2px solid #000000; width: 6px; font-size: 9px;">ĐVT</th>
        <th style="border: 2px solid #000000; width: 8px; font-size: 9px;">Số lượng</th>
        <th style="border: 2px solid #000000; width: 12px; font-size: 9px;">Đơn giá</th>
        <th style="border: 2px solid #000000; width: 14px; font-size: 9px;">Thành tiền</th>
...
<table>
    <tr>
        <th colspan="7" style="text-align: center">Bảng thống kê theo nhà cung cấp trong tháng</th>
    </tr>
    <tr>
        <td colspan="7"></td>
        <td colspan="7"></td>
...
@foreach($ncc as $i => $value)
    <table>
        <tr>
            <th colspan="7">Nhà cung cấp: {{$i}}</th>
        </tr>
    </table>
    <table class="table">
        <tr>
