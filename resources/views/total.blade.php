...
<div class="container">
    <h3 class="text-center titler">Thống Kê Phân Trại: {{$area->name}}</h3>
    <div class="d-flex">
...
{{--        <tbody>--}}
            <tr>
                ...
                <td>
                    <a href="{{asset('area/'.$area->id.'/'.$item->id)}}" class="btn btn-warning btn-sm" title="Sửa" style="float: left; margin-right: 6px;">Sửa</a>
        ...
        <form action="{{route('postProduct')}}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="date" name="date_create" class="form-control" id="date_create" value="{{$date}}" required>
